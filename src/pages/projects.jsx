        ...
        <ScrollReveal>
          <section className="mb-[15%] mt-[10%] max-w-[85vw] w-full  grid gap-[3%] font-bold">
              ...
              <article className="grid grid-cols-4 h-[100%]">
                <CardProject text="creado para hacer esto" title="Porfolio" img="/imgs/porfolio.jpeg" linkGit="git@github.com:Agustincito1/portfolio-2.0.git" arrayLeng={Project1}></CardProject>
