          ...
          <section className="mb-[15%] mt-[10%] max-w-[85vw] w-full font-bold grid gap-[2%]">
            ...
            <article className='grid gap-[20%]'>
              <div className='grid gap-[4%]'>
                <h2 className='subtitle text-[var(--ml)] flex items-center gap-[1%]'><div className=" shadow bg-[var(--lk)] w-[2vw] h-[2vw] rounded-full"></div><a href='https://www.facebook.com/EPET34/' className="transition 0.4s hover:text-[var(--am)]" target="_blank">Epet 34</a> (2021 - 2024)</h2>
